...
HLS_SOURCES = ../../../../../lms_filter_tb.cpp ../../../../../lms_filter.cpp
...
$(ObjDir)/lms_filter_tb.o: ../../../../../lms_filter_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../lms_filter_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/lms_filter_tb.d
