set moduleName lms_filter_Pipeline_VITIS_LOOP_40_2
set isTopModule 0
...
set cdfgNum 6
set C_modelName {lms_filter_Pipeline_VITIS_LOOP_40_2}
...
set C_modelArgList {
	{ y_out float 32 regular {pointer 1}  }
...
set portList { 
	...
	{ y_out sc_out sc_lv 32 signal 0 } 
	{ y_out_ap_vld sc_out sc_logic 1 outvld 0 } 
