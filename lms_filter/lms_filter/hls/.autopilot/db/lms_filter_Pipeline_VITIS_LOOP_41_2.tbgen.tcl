set moduleName lms_filter_Pipeline_VITIS_LOOP_41_2
set isTopModule 0
...
set cdfgNum 6
set C_modelName {lms_filter_Pipeline_VITIS_LOOP_41_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict weights { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ add255_out float 32 regular {pointer 1}  }
	{ weights float 32 regular {array 16 { 1 3 } 1 1 } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "add255_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add255_out sc_out sc_lv 32 signal 0 } 
	{ add255_out_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ weights_address0 sc_out sc_lv 4 signal 1 } 
	{ weights_ce0 sc_out sc_logic 1 signal 1 } 
	{ weights_q0 sc_in sc_lv 32 signal 1 } 
	{ x_buf_address0 sc_out sc_lv 4 signal 2 } 
	{ x_buf_ce0 sc_out sc_logic 1 signal 2 } 
	{ x_buf_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add255_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add255_out", "role": "default" }} , 
 	{ "name": "add255_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "add255_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	add255_out { ap_vld {  { add255_out out_data 1 32 }  { add255_out_ap_vld out_vld 1 1 } } }
