...
HD_PWD='D:/VHDl/ZYNQ/ZYNQ.runs/design_1_DAC_SigmaDelta_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DAC_SigmaDelta_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DAC_SigmaDelta_0_1.tcl
