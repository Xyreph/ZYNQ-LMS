namespace eval ::optrace {
  variable script "D:/VHDl/ZYNQ/ZYNQ.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/matth/AppData/Roaming/Xilinx/Vivado/2025.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:cora-z7-07s:part0:1.1 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/VHDl/ZYNQ/ZYNQ.cache/wt [current_project]
  set_property parent.project_path D:/VHDl/ZYNQ/ZYNQ.xpr [current_project]
  set_property ip_repo_paths {
  D:/VHDl/IP/DAC_SigmaDelta
  D:/VHDl/SinePhaseInverter
} [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/VHDl/ZYNQ/ZYNQ.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/VHDl/ZYNQ/ZYNQ.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/VHDl/ZYNQ/ZYNQ.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc D:/VHDl/ZYNQ/ZYNQ.srcs/constrs_1/new/V_Pins.xdc
